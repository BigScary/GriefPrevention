...
public class DeathBlowCommand extends GriefPreventionCommand {
	...
	public boolean onCommand(CommandSender sender, Command command,
		...
		// if giving inventory to another player, teleport the target player to
		// that receiving player
		if (recipientPlayer != null) {
		...
		// otherwise, plan to "pop" the player in place
			...
			// if in a normal world, shoot him up to the sky first, so his items
			// will fall on the surface.
