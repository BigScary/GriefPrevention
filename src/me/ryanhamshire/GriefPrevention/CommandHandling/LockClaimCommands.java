	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if (command.getName().equalsIgnoreCase("lockclaim") && player != null) {
			...
			Claim claim = dataStore.getClaimAt(player.getLocation(), true /*
																		 ...
																		 * height
																		 */);
			if ((player.hasPermission(PermNodes.LockClaimsPermission) && claim.getOwnerName().equalsIgnoreCase(player.getName())) || player.hasPermission(PermNodes.AdminLockPermission)) {
