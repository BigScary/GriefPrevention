...
public class ModdedBlocksSearchResults {
	...
	public static void saveMaterialList(List<MaterialInfo> source,
			String NodePath, FileConfiguration Target) {
	...
	public MaterialCollection readMaterialList(List<MaterialInfo> source,
			String NodePath, FileConfiguration Source) {
		...
		GriefPrevention.instance.parseMaterialListFromConfig(AcquiredStrings,
				readList);
		return readList;
	}
