...
/**
 * given a Inclusion and exclusion pattern, compiles a RegEx Pattern and can be
 * used to test that a string matches the first pattern but not the second.
 * 
...
public class RegExTestHelper {
	...
	/**
	 * returns true if the given parameter is excluded. This will only be true
	 * if it also matches the included parameter.
	 * 
	 * @param teststring
	 * @return
	 */
